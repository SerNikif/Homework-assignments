...
async def get_buying_list(message):
    await message.answer('Название: Product 1 | Описание: Комиксы | Цена: 100')
    with open("file/1.png", 'rb') as img:
        await message.answer_photo(img, reply_markup=kb0)
    await message.answer('Название: Product 2 | Описание: Комиксы | Цена: 200')
    with open("file/2.png", 'rb') as img:
        await message.answer_photo(img, reply_markup=kb0)
    await message.answer('Название: Product 3 | Описание: Комиксы | Цена: 300')
    with open("file/3.png", 'rb') as img:
        await message.answer_photo(img, reply_markup=kb0)
    await message.answer('Название: Product 4 | Описание: Комиксы | Цена: 400')
